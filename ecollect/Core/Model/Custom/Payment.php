<?php
namespace ecollect\Core\Model\Custom;
 ...
 * Class Payment
 *
 * @package ecollect\Core\Model\Custom
...
//        return false;
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        //$infoForm = $infoForm['ecollect_custom'];
    ...
    public function preparePostPayment($usingSecondCardInfo = null)
    {
        ...
        $preference['binary_mode'] = $this->_scopeConfig->isSetFlag('payment/ecollect_custom/binary_mode');
        $preference['statement_descriptor'] = $this->_scopeConfig->getValue('payment/ecollect_custom/statement_descriptor');
    ...
    public function isAvailable(\Magento\Quote\Api\Data\CartInterface $quote = null)
    {
        ...
        if (!$this->_accessToken) {
            $this->_accessToken = $this->_scopeConfig->getValue(\ecollect\Core\Helper\Data::XML_PATH_ACCESS_TOKEN, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        }
        if (!$this->_publicKey) {
            $this->_publicKey = $this->_scopeConfig->getValue(\ecollect\Core\Helper\Data::XML_PATH_PUBLIC_KEY, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        }
        ...
        $debugMode = $this->_scopeConfig->getValue('payment/ecollect/debug_mode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
