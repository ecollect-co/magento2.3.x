<?php
namespace ecollect\Core\Model\Quote;

/**
 * Class DiscountCoupon
 *
 * @package ecollect\Core\Model\Quote
 */
class DiscountCoupon
    extends \Magento\Quote\Model\Quote\Address\Total\AbstractTotal
{
    ...
    protected function _getDiscountCondition($address, $shippingAssignment)
    {
        ...
        $updateFlag = ($this->_registry->registry('ecollect_discount_amount') !== null);
    ...
    {
        $amount = $this->_registry->registry('ecollect_discount_amount');
