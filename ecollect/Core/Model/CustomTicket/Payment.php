...
namespace ecollect\Core\Model\CustomTicket;

/**
 * Class Payment
 *
 * @package ecollect\Core\Model\CustomTicket
 */
class Payment
    extends \ecollect\Core\Model\Custom\Payment
{
    /**
     * Define payment method code
     */
    const CODE = 'ecollect_customticket';
    ...
    {
        $this->_helperData->log("Ticket -> init prepare post payment", 'ecollect-custom.log');
        ...
        $this->_helperData->log("Ticket -> PREFERENCE to POST /v1/payments", 'ecollect-custom.log', $preference);
