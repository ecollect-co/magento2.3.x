    ...
    implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        return [
            'payment' => [
                $this->methodCode => [
                    'bannerUrl'        => $this->_scopeConfig->getValue('payment/ecollect_custom/banner_checkout', \Magento\Store\Model\ScopeInterface::SCOPE_STORE),
                    'country'          => strtoupper($this->_scopeConfig->getValue('payment/ecollect/country', 'default', $this->_storeManager->getStore()->getId())),
                    ...
                    'logEnabled'       => $this->_scopeConfig->getValue('payment/ecollect/logs', 'default', $this->_storeManager->getStore()->getId()),
                    'discount_coupon'  => $this->_scopeConfig->isSetFlag('payment/ecollect_custom/coupon_ecollect', 'default', $this->_storeManager->getStore()->getId()),
                    'second_card'      => $this->_scopeConfig->isSetFlag('payment/ecollect_custom/allow_2_cards', 'default', $this->_storeManager->getStore()->getId()),
                    'route'            => $this->_request->getRouteName(),
                    'public_key'       => $this->_scopeConfig->getValue('payment/ecollect_custom/public_key', \Magento\Store\Model\ScopeInterface::SCOPE_STORE),
