...
namespace ecollect\Core\Model\Api\V1;
/**
 *  Exception which thrown by ecollect API in case of processable error codes from api v1
 *
 * Class Exception
 *
 * @package ecollect\Core\Model\Api\V1
 */
class Exception
    extends \ecollect\Core\Model\Api\Exception
{
    /**
     *  map messages
     *
