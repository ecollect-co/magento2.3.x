...
namespace ecollect\Core\Model\Api;

/**
 * Exception which thrown by MercadoPago API in case of processable error codes
 * Class ecollect_Core_Model_Api_Exception
 *
 * @package ecollect\Core\Model\Api\Exception
 */
class Exception
    extends \Magento\Framework\Exception\LocalizedException
{
    ...
    {
        if (!empty($error)) {
            if ($this->_scopeConfig->isSetFlag('payment/ecollect/debug_mode', \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE)) {
