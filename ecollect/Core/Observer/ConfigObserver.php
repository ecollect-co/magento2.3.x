    ...
    implements ObserverInterface
{
    ...
    private $banners = [
        "ecollect_custom"       => [
            ...
            "mco" => "https://a248.e.akamai.net/secure.mlstatic.com/components/resources/mp/css/assets/desktop-logo-ecollect.png",
            ...
            "mpe" => "https://a248.e.akamai.net/secure.mlstatic.com/components/resources/mp/css/assets/desktop-logo-ecollect.png",
        ],
        "ecollect_customticket" => [
            "mla" => "https://a248.e.akamai.net/secure.mlstatic.com/components/resources/mp/css/assets/desktop-logo-ecollect.png",
            "mlb" => "http://imgmp.mlstatic.com/org-img/MLB/MP/BANNERS/2014/230x60.png",
            "mco" => "https://a248.e.akamai.net/secure.mlstatic.com/components/resources/mp/css/assets/desktop-logo-ecollect.png",
            "mlm" => "https://a248.e.akamai.net/secure.mlstatic.com/components/resources/mp/css/assets/desktop-logo-ecollect.png",
            "mlc" => "https://secure.mlstatic.com/developers/site/cloud/banners/cl/468x60.gif",
            "mlv" => "https://imgmp.mlstatic.com/org-img/banners/ve/medios/468X60.jpg",
            "mpe" => "https://a248.e.akamai.net/secure.mlstatic.com/components/resources/mp/css/assets/desktop-logo-ecollect.png",
        ],
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $this->checkBanner('ecollect_custom');
        $this->checkBanner('ecollect_customticket');
        $this->checkBanner('ecollect_standard');
    ...
    public function availableCheckout()
    {
        ...
        if (!in_array($country, $this->available_transparent_credit_cart)) {
            $this->_saveWebsiteConfig(\ecollect\Core\Helper\Data::XML_PATH_MERCADOPAGO_CUSTOM_ACTIVE, 0);
        }

        if (!in_array($country, $this->available_transparent_ticket)) {
            $this->_saveWebsiteConfig(\ecollect\Core\Helper\Data::XML_PATH_MERCADOPAGO_TICKET_ACTIVE, 0);
        }
    }
    ...
    public function setSponsor()
    {
        /*$sponsorIdConfig = $this->_scopeConfig->getValue(
            \ecollect\Core\Helper\Data::XML_PATH_SPONSOR_ID,
            \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE,
            $this->_scopeCode
        );
        ...
        $this->_saveWebsiteConfig(\ecollect\Core\Helper\Data::XML_PATH_SPONSOR_ID, $sponsorId);
    ...
    protected function validateAccessToken()
    {
        ...
        if (!empty($accessToken)) {
            if (!$this->coreHelper->isValidAccessToken($accessToken)) {
                throw new \Magento\Framework\Exception\LocalizedException(__('e-Collect - Custom Checkout: Invalid access token'));
            }
        }*/
    }
    ...
    protected function validateClientCredentials()
    {
        ...
        if (!empty($clientId) && !empty($clientSecret)) {
            if (!$this->coreHelper->isValidClientCredentials($clientId, $clientSecret)) {
                throw new \Magento\Framework\Exception\LocalizedException(__('e-Collect: Invalid client id or client secret'));
            }
        }
    }
    ...
    protected function validateRefundData()
    {
        $refundAvailable = $this->_scopeConfig->getValue(
            \ecollect\Core\Helper\Data::XML_PATH_REFUND_AVAILABLE,
            \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE,
            $this->_scopeCode
        );
        ...
        if ($refundAvailable) {
            $maxDays = $this->_scopeConfig->getValue(
                \ecollect\Core\Helper\Data::XML_PATH_MAXIMUM_DAYS_REFUND,
                \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE,
                $this->_scopeCode
            );
            $maxRefunds = $this->_scopeConfig->getValue(
                \ecollect\Core\Helper\Data::XML_PATH_MAXIMUM_PARTIAL_REFUNDS,
                \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE,
                $this->_scopeCode
            );
            if (($maxDays === 0) || ($maxRefunds === 0)) {
                throw new \Magento\Framework\Exception\LocalizedException(__('e-Collect - If refunds are available, you must set \'Maximum amount of partial refunds on the same order\' and \'Maximum amount of days until refund is not accepted\''));
            }
        }
    }
    ...
    protected function sendAnalyticsData($api)
    {
        ...
        $standard = $this->_scopeConfig->getValue('payment/ecollect_standard/active',
            \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE,
            $this->_scopeCode);
        $custom = $this->_scopeConfig->getValue('payment/ecollect_custom/active',
            \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE,
            $this->_scopeCode);
        ...
        $twoCards = $this->_scopeConfig->getValue('payment/ecollect_custom/allow_2_cards',
            \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE,
            $this->_scopeCode);
        $customCoupon = $this->_scopeConfig->getValue('payment/ecollect_custom/coupon_ecollect',
            \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE,
            $this->_scopeCode);
        $customTicketCoupon = $this->_scopeConfig->getValue('payment/ecollect_customticket/coupon_ecollect',
            \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE,
            $this->_scopeCode);
