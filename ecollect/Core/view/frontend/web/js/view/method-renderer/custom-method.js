define(
    ...
    function ($, Component, quote, paymentService, paymentMethodList, getTotalsAction, fullScreenLoader,additionalValidators, setPaymentInformationAction, placeOrderAction, customer, setAnalyticsInformation) {
        ...
        return Component.extend({
            defaults: {
                template: 'ecollect_Core/payment/custom-method'
            },
            ...
            getData: function () {
                var dataObj = {
                    ...
                    'additional_data': {
                        ...
                        'total_amount': TinyJ('#ecollect_checkout_custom').getElem('.total_amount').val(),
                        'amount': TinyJ('#ecollect_checkout_custom').getElem('.amount').val(),
                        'site_id': this.getCountry(),
                        'token': TinyJ('#token').val(),
                        'payment_method_id': TinyJ('#ecollect_checkout_custom').getElem('#payment_method_id').val(),
                ...
                if (window.checkoutConfig.payment[this.getCode()] != undefined) {
                    if (window.checkoutConfig.payment[this.getCode()]['discount_coupon']) {
                        dataObj.additional_data['ecollect-discount-amount'] = TinyJ('#ecollect_checkout_custom').getElem('.ecollect-discount-amount').val();
                        dataObj.additional_data['coupon_code'] = TinyJ('#ecollect_checkout_custom').getElem('#input-coupon-discount').val();
                    }
                }
                if (this.isOCPReady()) {
                ...
                if (this.isSecondCardEnabled()) {
                    dataObj.additional_data['second_card_amount'] = TinyJ('#ecollect_checkout_custom_second_card').getElem('.second_card_amount').val();
                    dataObj.additional_data['second_card_installments'] = TinyJ('#second_card_installments').val();
                    dataObj.additional_data['second_card_payment_method_id'] = TinyJ('#ecollect_checkout_custom_second_card').getElem('.second_card_payment_method_id').val();
                    dataObj.additional_data['second_card_token'] = TinyJ('#ecollect_checkout_custom_second_card').getElem('.second_card_token').val();
                    dataObj.additional_data['first_card_amount'] = TinyJ('#ecollect_checkout_custom_second_card').getElem('.first_card_amount').val();
