var MercadoPagoCustom = (function () {
    ...
    var self = {
        messages: {
            init: 'Init e-Collect JS',
            initOCP: 'Init e-Collect OCP',
            initDiscount: 'Init e-Collect Custom Discount',
            initTicket: 'Init e-Collect Custom Ticket',
            mpIncorrectlyConfigured: 'e-Collect was not configured correctly. Public Key not found.',
        ...
        constants: {
            ...
            brazil: 'MLB',
            peru: 'MPE',
            ecollectCustom: 'ecollect_custom',
        ...
        selectors: {
            checkoutCustom: '#ecollect_checkout_custom',
            checkoutTicket: '#ecollect_checkout_custom_ticket',
            siteId: '#ecollect_checkout_custom .site_id',
            cardNumberInput: '#cardNumber__mp input[data-checkout="cardNumber"]',
            installmentsDontWork: '.error-installment-not-work',
            ecollectCustomOpt: '#ecollect_custom',
            ...
            oneClickPayment: '#ecollect_checkout_custom #one_click_pay_mp',
            installmentText: '#ecollect_checkout_custom .ecollect-text-installment',
            paymentMethod: '#paymentMethod',
            paymentMethodSelect: '#paymentMethod',
            paymentMethodId: '#ecollect_checkout_custom #payment_method_id',
            paymentMethodNotFound: '.error-payment-method-not-found',
            mercadoPagoTextChoice: '#ecollect_checkout_custom .ecollect-text-choice',
            errorMethodMinAmount: '.error-payment-method-min-amount',
            textDefaultIssuer: '#ecollect_checkout_custom .ecollect-text-default-issuer',
            customCard: '#ecollect_checkout_custom_card',
            ocp: '#ecollect_checkout_custom_ocp',
            mercadoRoute: '#ecollect_checkout_custom .mercado_route',
            baseUrl: '.mercado_base_url',
            loading: '#ecollect-loading',
            messageError: '.message-error',
            firstCardErrors: '#ecollect_checkout_custom .message-error',
            customDiscountAmount: '#ecollect_checkout_custom .ecollect-discount-amount',
            discountAmount: '.ecollect-discount-amount',
            token: '#ecollect_checkout_custom .token',
            errorFormat: '#ecollect_checkout_custom .error-{0}',
            errorFormatSecondCard: '#second_card_payment_form_ecollect_custom .second_card_error-{0}',
            couponActionApply: '.ecollect-coupon-action-apply',
            couponActionRemove: '.ecollect-coupon-action-remove',
            ticketActionApply: '#ecollect_checkout_custom_ticket .ecollect-coupon-action-apply',
            ticketActionRemove: '#ecollect_checkout_custom_ticket .ecollect-coupon-action-remove',
            coupon: '.ecollect_coupon',
            couponLoading: '.ecollect-message-coupon .loading',
            couponList: '.ecollect-message-coupon li',
            textCurrency: '.ecollect-text-currency',
            discountOk: '.ecollect-message-coupon .discount-ok',
            messageCoupon: '.ecollect-message-coupon',
            discountOkAmountDiscount: '.ecollect-message-coupon .discount-ok .amount-discount',
            discountOkTotalAmount: '.ecollect-message-coupon .discount-ok .total-amount',
            discountOkTotalAmountDiscount: '.ecollect-message-coupon .discount-ok .total-amount-discount',
            discountOkTerms: '.ecollect-message-coupon .discount-ok .ecollect-coupon-terms',
            inputCouponDiscount: '#input-coupon-discount',
            mageErrorMessages: '#ecollect_checkout_custom .mage-error',

            checkoutCustomSecondCard: '#ecollect_checkout_custom_second_card',
            showSecondCard: '#show_second_card',
            hideSecondCard: '#hide_second_card',
            secondCard: '#ecollect_checkout_custom_second_card',
            secondCardErrors: '#ecollect_checkout_custom_second_card .message-error',
            ...
            secondCardCustomCard: '#second_card_ecollect_checkout_custom',
            ...
            secondCardInstallmentText: '.second_card_ecollect-text-installment',
            secondCardInstallments: '#second_card_installments',
            ocpSecondCard: '#second_card_payment',
            dataCheckoutSecondCard: '[data-checkout]',
            tokenSecondCard: '#ecollect_checkout_custom_second_card .second_card_token',
            ...
            secondCardMageErrorMessages: '#ecollect_checkout_custom_second_card .mage-error',
            paymentMethodNotFoundSecondCard: '.second_card_error-payment-method-not-found',


        },
        url: {
            amount: 'ecollect/api/amount',
            couponUrlFormat: 'ecollect/api/coupon?id={0}',
            termsUrlFormat: "https://api.mercadolibre.com/campaigns/{0}/terms_and_conditions?format_type=html",
            subtotals: 'ecollect/api/subtotals'
        },
        enableLog: true,
        paymentService: null,
...
// MERCADO LOG
    ...
    function InitializeNewModule() {
        ...
        function setPaymentMethodsInfo(methods) {
            ...
            var message_choose = document.querySelector(".ecollect-text-choice").value;
